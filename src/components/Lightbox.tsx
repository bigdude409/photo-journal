  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24">
            <g transform="rotate(45, 12, 12)">
              ...
              <path d="M6 12 h 12 m -6 -6 v 12" stroke={isHovered ? 'var(--text-color)' : '#888'} strokeWidth="1" strokeLinecap="round"/>
            </g>
          </svg>
        </button>
        ...
        <div style={{ color: 'var(--text-color)', fontSize: '14px' }} className="mt-4 p-2 text-right">
